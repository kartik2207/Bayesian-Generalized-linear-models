...
def new_data_table(data_table):

    data_table.insert(0,"null",1)
    data_table_w=data_table
    print(data_table_w)
    return data_table_w
data='A.csv'
label='labels-A.csv'
...
def pd_to_numpy_converter(data_table_w,labels_df):
    data_vector=data_table_w.values
...
def final_main(data_table_w, labels_df):
    ...
    for element in range(0,30):
        ...
        for i in range(1,11):
            ...
            w_new,ite,t = newton_update(train_data_vector, train_label_vector, regression='logistic',alpha=10)
